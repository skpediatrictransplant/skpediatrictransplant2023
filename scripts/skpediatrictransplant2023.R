## this script reproduces the results from the manuscript using a subset of the data for faster runtimes.
...
source('skpediatrictransplant2023/scripts/skpediatrictransplant2023-functions.R')
